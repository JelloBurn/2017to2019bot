...
//	public LeftTurnAuto(RobotDrive driveTrain, Tracker trackIn)
//	{
//		chassis = driveTrain;
//		track = trackIn;
...
//	}
	...
	public LeftTurnAuto(MecanumDrive driveTrain, Tracker trackIn)
	{
		chassis = driveTrain;
		track = trackIn;
		autoState = State.BEGIN;
	...
	private void driveForward()
	{
		if(previousState == State.BEGIN)
		{
			...
			{
				//chassis.mecanumDrive_Cartesian(0, maximumDriveSpeed, 0, 0);
				chassis.driveCartesian(0, maximumDriveSpeed, 0);
			}
		}
	...
	private void debug()
	{
		SmartDashboard.putString("LeftTurnAuto Debug State", this.autoState.toString());
