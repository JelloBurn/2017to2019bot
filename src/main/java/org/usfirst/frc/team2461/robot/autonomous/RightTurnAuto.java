...
//	public RightTurnAuto(RobotDrive driveTrain, Tracker trackIn)
//	{
//		chassis = driveTrain;
//		track = trackIn;
...
//	}
	...
	public RightTurnAuto(MecanumDrive driveTrain, Tracker trackIn)
	{
		chassis = driveTrain;
		track = trackIn;
		autoState = State.BEGIN;
	...
	private void debug()
	{
		SmartDashboard.putString("RightTurnAuto Debug State", this.autoState.toString());
